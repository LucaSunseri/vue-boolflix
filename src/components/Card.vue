        ...
        <div class="flip-card-inner">
            ...
            <div class="flip-card-back">
                ...
                <div v-else class="title">
                    <p><span class="ls-text-card">Titolo: </span>{{ title }}</p>
                    <p>
                        <span class="ls-text-card">Titolo originale: </span
                        >{{ originalTitle }}
                    </p>
                </div>
                <!-- Section Language -->
                ...
                <div>
                    <span class="ls-text-card">Voto: </span>
                    <b-icon
                        v-for="index in voteAverage"
                        :key="index + `A`"
                        icon="star-fill"
                        font-scale="1"
                    ></b-icon>
                    <b-icon
                        v-for="index in 5 - voteAverage"
                        :key="index + `B`"
                        icon="star"
                        font-scale="1"
                    ></b-icon>
                ...
                <!-- Section Overview -->
                <div v-if="overview">
                    <span class="ls-text-card">Trama: </span> <br />
                    <p class="ls-overview">{{ overview }}</p>
                </div>
            </div>
        </div>
    </div>
